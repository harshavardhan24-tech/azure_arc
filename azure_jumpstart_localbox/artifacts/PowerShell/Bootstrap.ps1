...
$templateBaseUrl = "https://raw.githubusercontent.com/harshavardhan24-tech/azure_arc/refs/heads/main/azure_jumpstart_localbox/"
...
# Creating scheduled task for WinGet.ps1Add commentMore actions
